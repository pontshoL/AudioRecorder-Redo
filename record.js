...
export default function Record(route) {
  ...
  return (
      ...
      <Text style={{color:'#956b81', marginBottom:350, alignSelf: "center",fontSize: 20}}>AUDIO RECORDER</Text>
      <Text>{message}</Text>
      <View style={styles.view}>
        ...
        <View style={{borderWidth:1,
          borderColor:'black',
           ...
           ,height:250,width:250, marginTop: -250,
           alignContent:'center'}}>
            {
                recording ? (
